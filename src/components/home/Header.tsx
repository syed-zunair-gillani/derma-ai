...
export default function Header() {
  return (
    <header className="w-full flex items-center justify-between px-6 py-4 bg-white/80 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link href="#" className="bg-[#0b103e] hover:bg-blue-900 text-white text-sm font-medium py-2 px-5 rounded-full transition-all shadow-md hover:shadow-lg">
          Sign Up
        </Link>
      </div>
    </header>
